#!/bin/bash
#
# 这是一个自动化测试脚本，用于对 resources/filtered_images 目录下的所有图片运行 NES 对抗性攻击。
#
# 使用方法:
# ./scripts/run_nes_attack_batch.sh <path_to_executable>
#
# 示例:
# ./scripts/run_nes_attack_batch.sh resources/execution_files/emotion_ferplus_mnn
#
# ==============================================================================
...
# NES 特定攻击参数
specific_args="--population-size 50 --sigma 0.6"
