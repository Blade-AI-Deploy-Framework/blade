#!/bin/bash
#
# 这是一个自动化测试脚本，用于对 resources/filtered_images 目录下的所有图片运行 Square 对抗性攻击。
#
# 使用方法:
# ./scripts/run_square_attack_batch.sh <path_to_executable>
#
# 示例:
# ./scripts/run_square_attack_batch.sh resources/execution_files/emotion_ferplus_mnn
#
# ==============================================================================
...
ITERATIONS=1000
L_INF_NORM=20.0
LEARNING_RATE=5.0 # Square attack 不使用学习率，参数保留以保持统一

# Square 特定攻击参数
specific_args="--p-init 0.5"
