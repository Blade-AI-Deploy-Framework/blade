#!/bin/bash
#
# 这是一个自动化测试脚本，用于对 resources/filtered_images 目录下的所有图片运行 ZOSignSGD 对抗性攻击。
#
# 使用方法:
# ./scripts/run_zosignsgd_attack_batch.sh <path_to_executable>
#
# 示例:
# ./scripts/run_zosignsgd_attack_batch.sh resources/execution_files/emotion_ferplus_mnn
#
# ==============================================================================
...
# ZOSignSGD 特定攻击参数
specific_args="--num-queries 50 --fd-eta 0.15"
